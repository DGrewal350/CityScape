...
init()
{
    ...
    loadBMP_custom(&pic2, &w, &h, "Brick2.bmp");
    ...
    loadBMP_custom(&pic3, &w, &h, "Brick1.bmp");
    ...
    loadBMP_custom(&pic4, &w, &h, "Sky.bmp");
...
display( void )
{
    ...
    glUniform1f( glGetUniformLocation(program, "st_factor"), 4.0 );
